...
module Thredded
  describe News, '.friendly_find!' do
    it 'finds the news' do
  ...
  #     defaults = {}
  #     @topic_with_user = create(:tonews.rbpic, user: @user, **defaults)
  ...
  #     topic = create(:movie, title: 'My movie')
  #
