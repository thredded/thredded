...
class UpgradeV02ToV03 < ActiveRecord::Migration
  def up
    ...
    add_index :thredded_user_messageboard_preferences, %i[user_id messageboard_id], unique: true, name: :thredded_user_messageboard_preferences_user_id_messageboard_id
    ...
    %i[topic private_topic].each do |topics_table|
      ...
      add_index table_name, %i[user_id postable_id], name: :"#{table_name}_user_postable", unique: true
    end
  ...
  def down
    ...
    add_index :thredded_user_topic_reads, %i[user_id topic_id], name: :index_thredded_user_topic_reads_on_user_id_and_topic_id, unique: true
